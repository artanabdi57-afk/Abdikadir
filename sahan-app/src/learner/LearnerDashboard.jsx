...
<style>
  ...
  *{ box-sizing:border-box; }
  ...
  .collapse-btn{
    ...
    background:rgba(255,255,255,0.06); border:1px solid rgba(255,255,255,0.12); color:#C3D0C6;
    display:flex; align-items:center; justify-content:center;
  }
  ...
  .sidebar-label{
    ...
    color:#7C9187; margin:22px 6px 8px; white-space:nowrap;
  }
  ...
  .trail-nav{
    ...
    background:none; border:none; color:#C3D0C6; font-size:14px; font-weight:500;
    padding:9px 8px; text-align:left; border-radius:var(--radius-sm); white-space:nowrap; width:100%;
  }
  ...
  .badge{
    margin-left:auto; background:var(--marigold); color:var(--marigold-ink);
    font-family:var(--font-mono); font-size:10px; font-weight:700;
    border-radius:999px; padding:1px 6px; flex-shrink:0;
  }
  .app.collapsed .badge{ display:none; }

  .sidebar-spacer{ flex:1; }

  .teach-cta{
    background:var(--night-3); border:1px solid #33473C; color:#EDF2EA;
    font-size:12.5px; font-weight:600; padding:10px 12px; border-radius:var(--radius-sm);
    margin-bottom:14px; display:flex; justify-content:space-between; align-items:center; white-space:nowrap;
  }
  ...
  .avatar-btn{
    background:none; border:none; padding:0; border-radius:50%; flex-shrink:0;
  }
  .avatar{
    width:34px; height:34px; border-radius:50%;
    background:var(--night-3); border:1.5px solid #3A5044; color:#F3F6F0;
    display:flex; align-items:center; justify-content:center;
  ...
  .signout-btn{
    ...
    background:none; border:1px solid transparent; color:#8DA091;
  ...
  .topbar{
    ...
    padding:16px 40px; border-bottom:1px solid var(--line); background:var(--paper-2);
  ...
  .search input{
    width:100%; border:1px solid var(--line); background:var(--paper); border-radius:999px;
    padding:9px 14px 9px 34px; font-size:13.5px; color:var(--ink);
  }
  ...
  /* ---------- home hero ---------- */
  .hero{
    display:grid; grid-template-columns:1fr 300px; gap:28px; background:var(--night); color:#EDF2EA;
    border-radius:var(--radius-lg); padding:36px 38px; margin-bottom:42px; position:relative; overflow:hidden;
  }
  .hero::after{
    content:""; position:absolute; inset:0;
    background:radial-gradient(420px 220px at 88% -10%, rgba(242,169,59,0.16), transparent 70%),
  ...
  .hero-card{
    ...
    padding:20px; display:flex; flex-direction:column; align-items:flex-start; gap:10px; position:relative;
  }
  ...
  .course{
    background:var(--paper-2); border:1px solid var(--line); border-radius:var(--radius-md); overflow:hidden;
    display:flex; flex-direction:column; box-shadow:var(--shadow-card); transition:transform .15s ease, box-shadow .15s ease;
  }
  ...
  /* ---------- profile page ---------- */
  .profile-header{
    display:flex; align-items:center; gap:20px; background:var(--night); color:#EDF2EA;
    border-radius:var(--radius-lg); padding:30px 34px; margin-bottom:36px; position:relative; overflow:hidden;
  }
  ...
  .profile-avatar-lg{
    width:72px; height:72px; border-radius:50%; background:var(--marigold); color:var(--marigold-ink);
    font-family:var(--font-mono); font-weight:700; font-size:22px; display:flex; align-items:center; justify-content:center;
    flex-shrink:0; position:relative; border:3px solid rgba(255,255,255,0.14);
  }
  ...
  .cert-stamp{
    width:38px; height:38px; border-radius:50%; border:2px dashed var(--marigold-dark); color:var(--marigold-dark);
    display:flex; align-items:center; justify-content:center; margin-bottom:12px; transform:rotate(-4deg); position:relative;
  }
  ...
  /* ---------- community page ---------- */
  .community-shell{ display:grid; grid-template-columns:220px 1fr; gap:0; border:1px solid var(--line); border-radius:var(--radius-md); overflow:hidden; background:var(--paper-2); height:520px; margin-bottom:40px; }
  .channels{ background:var(--paper); border-right:1px solid var(--line); padding:14px 10px; overflow-y:auto; }
  .channels-label{ font-family:var(--font-mono); font-size:10px; letter-spacing:0.12em; color:var(--muted); padding:6px 8px 8px; }
  ...
  @media (max-width:900px){
    ...
    .community-shell{ grid-template-columns:1fr; height:auto; }
    .channels{ border-right:none; border-bottom:1px solid var(--line); display:flex; gap:6px; overflow-x:auto; }
...
<div class="app" id="app">
  ...
  <aside class="sidebar">
    ...
    <nav class="trail">
      <button class="trail-nav active" data-page="home">
      ...
      <button class="trail-nav" data-page="discover">
      ...
      <button class="trail-nav" data-page="learning">
      ...
      <button class="trail-nav" data-page="community">
    ...
    <nav class="trail">
      <button class="trail-nav settings-row" data-page="settings">
  ...
  <main class="main">
    ...
    <section class="content page" id="page-home">
      ...
      <div class="section-head">
        <div><h2>Continue learning</h2><p>Courses attached to your account.</p></div>
      </div>
    ...
    <section class="content page" id="page-community" style="display:none;">
      <div class="page-title">
        ...
        <h1>Talk to other learners.</h1>
        <p>Join channels tied to your courses, ask questions, and see what's moving across Sahan right now.</p>
      </div>
      <div class="community-shell">
        <div class="channels">
          ...
          <div class="channels-label" style="margin-top:14px;">DIRECT</div>
          <button class="channel" data-ch="dm-hodan"><span class="hash">@</span>Hodan A.</button>
        </div>
        <div class="chat">
          <div class="chat-head" id="chatHead"># General</div>
          <div class="chat-messages" id="chatMessages"></div>
          <div class="chat-input">
            <input id="chatInput" placeholder="Message #general…" onkeydown="if(event.key==='Enter')sendMessage()">
    ...
    <section class="content page" id="page-profile" style="display:none;">
      ...
      <div class="section-head">
        <div><h2>Certificates</h2><p>Issued when you complete a course's full trail.</p></div>
      </div>
      ...
      <div class="section-head">
        <div><h2>Account</h2><p>Same details as Settings — edit them there.</p></div>
      </div>
      <div class="settings-card">
...
const channelData = {
  ...
  "dm-hodan":{ label:"@ Hodan A.", messages:[
...
function renderChat(){
  ...
  document.getElementById('chatHead').textContent = ch.label;
  document.getElementById('chatMessages').innerHTML = ch.messages.map(m=>`
    <div class="msg">
      <span class="avatar">${m.init}</span>
      <div class="msg-body"><b>${m.name}</b><time>${m.time}</time><div class="msg-bubble">${m.text}</div></div>
    </div>`).join('');
  document.getElementById('chatMessages').scrollTop = 999999;
  document.getElementById('chatInput').placeholder = `Message ${ch.label.replace('# ','#')}…`;
}
